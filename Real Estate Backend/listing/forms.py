...
class ListingForm(forms.ModelForm):
    class Meta:
        model = Listing
        fields= [
            'title', 'borough', 'description', 'area', 'listing_type', 'property_status', 'price', 'rental_frequency', 'location', 'latitude', 'longitude', 'rooms', 'pool', 'furnished', 'elevator', 'cctv', 'parking', 'wifi'
            ]
